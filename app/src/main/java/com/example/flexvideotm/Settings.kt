...
class Settings : Fragment() {
    ...
    private fun showPrivacyPolicyDialog() {
        val privacyPolicyText = loadPrivacyPolicyText()
    ...
    private fun showAccountSettingsDialog() {
        ...
        val dialogView = inflater.inflate(R.layout.dialog_account_settings, null)
        ...
        dialogBuilder.setPositiveButton("Bestätigen") { dialog, _ ->
            ...
            // Hier kannst du den Code schreiben, um die neuen Benutzerdaten zu verarbeiten
            // z.B. speichern oder weiterverarbeiten
